...
import com.sternkn.inhibernate.entities.im2.BankAccount;
import com.sternkn.inhibernate.entities.im2.CreditCard;

public class TestPrintIM2
{
   private EntityManager em;
   
   public TestPrintIM2(EntityManager manager)
   {
      em = manager;
   }
   ...
   {
      List billings = em.createQuery("from com.sternkn.inhibernate.entities.im2.BillingDetails bd where bd.owner like 'Mikhail%'").getResultList();
