...
import com.sternkn.inhibernate.entities.im1.BankAccount;
import com.sternkn.inhibernate.entities.im1.CreditCard;

public class TestPrintIM1
{
   private EntityManager em;
   
   public TestPrintIM1(EntityManager manager)
   {
      em = manager;
   }
   ...
   {
      List billings = em.createQuery("from com.sternkn.inhibernate.entities.im1.BillingDetails bd where bd.owner like 'Mikhail%'").getResultList();
